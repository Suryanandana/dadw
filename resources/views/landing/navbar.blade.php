    ...
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between w-full p-4 mx-auto">
        ...
        <div class="flex md:order-2 gap-3">
            ...
            <div class="relative" x-data="{dropdown: false}">
                ...
                <!-- Dropdown menu -->
                <div x-show="dropdown"
                    class="z-10 absolute right-0 top-5 translate-y-10 translate-x-8 bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
                    ...
                    <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="avatarButton">
                        ...
                        <li>
                            <form action="/email/verification-notification" method="POST" class="">
                                @csrf
                                <button type="submit" class="px-4 py-2 w-full inline-flex justify-between items-center text-left hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                                    Verify Your Email

<footer class="border-t border-gray-300 text-gray-700 mt-6 py-4 px-10 flex flex-col md:flex-row justify-between gap-3 md:gap-0">
    <div class="flex gap-4 justify-center">
        <i class="fa-brands fa-facebook text-xl"></i>
        <i class="fa-brands fa-instagram text-xl"></i>
        <i class="fa-brands fa-whatsapp text-xl"></i>
    </div>
    <div class="flex flex-col md:flex-row-reverse items-center gap-1">
        <div class="flex items-center">
            ...
            <span id="logo" class="font-serif text-nowrap">The Cajuput Spa</span>

            <ul class="list-disc ms-6">
                <li class="text-sm">All Right Reserved</li>
            </ul>
        </div>

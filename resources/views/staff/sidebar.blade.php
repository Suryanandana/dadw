        ...
        <ul class="dark:border-gray-700">
            ...
            <li>
                <a href="/staff/transaction"
                    ...
                    <span class="ml-3">Transaction Validation</span>
                </a>
            </li>
            <li>
                <a href="{{ route('room') }}"

                                        ...
                                        <ul class="space-y-2 text-sm" aria-labelledby="filterDropdownButton">
                                            <li class="flex items-center">
                                                <input id="apple" type="checkbox" value=""
                                                    class="w-4 h-4 text-green-600 bg-gray-100 border-gray-300 rounded focus:ring-green-500 dark:focus:ring-green-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                                                <label for="apple"
                            ...
                            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                <thead
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" class="px-4 py-3">Reservating Date</th>
                                ...
                                <tbody>
                                    ...
                                    <tr class="border-b dark:border-gray-700">
                                        ...
                                        <td class="px-4 py-3 max-w-[12rem] truncate">
                                            {{'Rp. '.number_format(num: $order->price * $order->pax, thousands_separator: '.')}}
                                        </td>
                                        <td class="px-4 py-3">
                                            <a href="{{ 'img/' . $order->img_receipt }}" >img</a>
                                        </td>
                                        <td class="px-4 py-3">
                                            {{ $order->status_booking }}
                                        </td>
                                        <td class="flex items-center justify-end px-4 py-3">
                                            <button id="apple-imac-27-dropdown-button-{{$order->id}}"
                                                data-dropdown-toggle="apple-imac-27-dropdown-{{$order->id}}"
                                            ...
                                            <div id="apple-imac-27-dropdown-{{$order->id}}"
                                                class="z-10 hidden bg-white divide-y divide-gray-100 rounded shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
                                                <ul class="py-1 text-sm"
                                                    aria-labelledby="apple-imac-27-dropdown-button-{{$order->id}}">
                                                    <li>
                            ...
                            <ul class="inline-flex items-stretch -space-x-px">
                                ...
                                <li>
                                    <a href="#" aria-current="page"
                                        class="z-10 flex items-center justify-center px-3 py-2 text-sm leading-tight text-green-600 border border-green-300 bg-green-50 hover:bg-green-100 hover:text-green-700 dark:border-gray-700 dark:bg-gray-700 dark:text-white">3</a>
                                </li>
                                <li>
                                    <a href="#"

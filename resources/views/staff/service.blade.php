...
<body>
    ...
    <div class="antialiased bg-gray-50 dark:bg-gray-900">
        ...
        <main class="h-auto p-1 pt-20 md:ml-64">
                            ...
                            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                <thead
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" class="px-4 py-3">Service Image</th>
            ...
            <div id="createModal" tabindex="-1" aria-hidden="true"
                ...
                <div class="relative w-full max-w-2xl max-h-full p-4">
                    ...
                    <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                        ...
                        <!-- Modal body -->
                        <form action="/staff/addservice" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="grid gap-4 mb-4 sm:grid-cols-2">
                                ...
                                <div class="col-span-2 ">
                                    ...
                                    <textarea name="details" id="details" rows="5"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                        placeholder="Details Service"></textarea>
                                </div>
                                <div>
                                    <button type="submit"
            ...
            @foreach ($data as $item)
                <!-- Read modal -->
                <div id="readModal{{ $item->id }}" tabindex="-" aria-hidden="true"
                    class="hidden backdrop-blur-sm backdrop-brightness-75 overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                    <div class="relative w-full max-w-xl max-h-full p-4">
                        ...
                        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <button type="button" data-modal-toggle="deleteModal{{ $item->id }}"
                ...
                <div id="updateModal{{ $item->id }}" tabindex="-1" aria-hidden="true"
                    ...
                    <div class="relative w-full max-w-2xl max-h-full p-4">
                        ...
                        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                            ...
                            <!-- Modal body -->
                            <form action="{{ route('update.service', ['id' => $item->id]) }}" method="post"
                                ...
                                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                                    ...
                                    <div class="col-span-2">
                                        ...
                                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-300" id="file_input_help">
                                            Only
                                            keep it empty if don't wanna change the image</p>
                                        <input type="file" name="image" id="imgdir"
                                            accept="image/png, image/jpeg, image/webp"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                    ...
                                    <div class="col-span-2 ">
                                        ...
                                        <textarea name="details" id="details" rows="5" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">{{
                                            $item->details
                                        }}</textarea>
                                    </div>
                ...
                <!-- Delete modal -->
                <form action="{{ route('delete.service', ['id' => $item->id]) }}" method="POST">
                    @csrf
                    @method('DELETE')

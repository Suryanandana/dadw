    ...
    <div class="antialiased bg-gray-50 dark:bg-gray-900">
        ...
        <main class="h-auto p-1 pt-20 md:ml-64">
                ...
                <div class="max-w-screen-xl px-4 mx-auto lg:px-12">
                    ...
                    <div class="relative overflow-hidden bg-white shadow-md dark:bg-gray-800 sm:rounded-lg">
                        ...
                        @if ($data->count() > 0)
                            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                <thead
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" class="px-4 py-4">Adress</th>
                                ...
                                <tbody>
                                    @foreach ($data as $userData)
                                        <tr class="border-b dark:border-gray-700">
                                            <td class="px-4 py-3">{{ $userData->name }}</td>
                                            <td class="px-4 py-3">{{ $userData->address }}</td>
                                            <td class="px-4 py-3">{{ $userData->country }}</td>
                                            <td class="px-4 py-3">{{ $userData->phone }}</td>
                                            <td class="px-4 py-3">{{ $userData->email }}</td>
                            ...
                            @else
                                <p class="py-4 text-sm text-center text-gray-700">Customer Account Empty !</p>
                            @endif
                        </div>
            ...
            @foreach ($data as $data) 
                ...
                <div id="updateProductModal-{{ $data->id }}" tabindex="-1" aria-hidden="true"
                    ...
                    <div class="relative w-full max-w-2xl max-h-full p-4">
                        ...
                        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                            ...
                            <!-- Modal body -->
                            <form action="{{ route('update.customer', ['id' => $data->id]) }}" method="post">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="address" id="address" value="{{ $data->address }}"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Address">
                                    </div>
                                    <div>
                                        <label for="country"
                                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Country</label>
                                        <input type="text" name="country" id="country" value="{{ $data->country }}"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Country">
                                    </div>
                                    <div>
                                        <label for="phone"
                                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Phone</label>
                                ...
                                <div class="flex items-center space-x-4">
                                    <button type="submit"
                                        class="text-white bg-green-400 hover:bg-green-600 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-green-400 dark:hover:bg-green-500 dark:focus:ring-green-600">Save
                                    </button>
                                </div>
                            </form>
                        </div>
                ...
                <!-- Delete modal -->
                <form action="{{ route('delete.customer', ['id' => $data->id]) }}" method="POST">
                    @csrf
                    @method('DELETE')

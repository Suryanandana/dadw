                        ...
                        <div
                            ...
                            <div
                                ...
                                <button type="button" id="createProductModalButton"
                                    ...
                                    class="flex items-center justify-center text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none text-emerald-400 dark:focus:ring-primary-800">
                            ...
                            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                ...
                                <tbody>
                                    @if ($data->count() > 0)
                                        ...
                                        @endforeach
                                    @else
                                        <p class="text-gray-700 ">Admin Account Empty !</p>
                                    @endif
                                </tbody>
                            </table>
                        </div>
                    ...
                    <div class="relative p-4 w-full max-w-2xl max-h-full">
                        ...
                        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                            ...
                            <form action="{{ route('add.admin') }}" method="POST">
                                ...
                                <button type="submit"
                                    class="text-green-400 inline-flex items-center bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                        ...
                        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                            ...
                            <form action="{{ route('update.user', ['id' => $data->id]) }}" method="post">
                                ...
                                <div class="flex items-center space-x-4">
                                    <button type="submit"
                                        class="text-white bg-green-400 hover:bg-green-600 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-green-400 dark:hover:bg-green-500 dark:focus:ring-green-600">Update
                                        product</button>
                                    <button type="button"

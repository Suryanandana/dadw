...
<body>            
    <section class="bg-gradient-to-bl from-green-50 via-lime-50 to-green-100 dark:bg-gray-900">
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0 gap-3">
            <div class="w-full bg-white rounded-md shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                <div class="p-6 sm:p-8">
                    ...
                    @endif
                    <h1
                        class="md:text-4xl text-center mb-4 font-bold text-gray-900 text-xl dark:text-white">
                            Login
                    </h1>        
                    <form class="space-y-4" action="/login" method="POST">
                        ...
                        <button type="submit"
                            class="w-full text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-sm text-sm px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Sign In
                        </button>
                        {{-- or --}}
                        <div class="inline-flex items-center justify-center w-full">
                            <hr class="w-full h-px my-2 bg-gray-700 border-0 dark:bg-gray-700">
                        ...
                        {{-- socialite button --}}
                        <a href="{{ route('socialite.redirect', 'google') }}" class="text-gray-800 w-full bg-white hover:bg-gray-50/90 focus:ring-4 focus:outline-none focus:ring-gray-50/50 font-medium rounded-sm text-sm px-5 py-2.5 text-center inline-flex items-center justify-center border border-gray-400">
                        ...
                        <a href="{{ route('socialite.redirect', 'facebook') }}" class="w-full justify-center text-white bg-[#3b5998] hover:bg-[#3b5998]/90 focus:ring-4 focus:outline-none focus:ring-[#3b5998]/50 font-medium rounded-sm text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#3b5998]/55">
                        ...
                        <p class="text-sm font-light text-center text-gray-500 dark:text-gray-400">
                            ...
                            <a href="/register" class="font-medium text-green-700 hover:underline dark:text-green-500">
                                Register
                            </a>
                        </p>
                        <div class="flex justify-center items-center">
                            <svg class="size-6 text-green-600" xmlns="http://www.w3.org/2000/svg" width="47" height="67" viewBox="0 0 47 67" fill="none">

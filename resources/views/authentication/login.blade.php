        ...
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
            ...
            <div
                ...
                <div class="p-6 sm:p-8">
                    ...
                    @endif                  
                    <h1
                        class="text-4xl text-center mb-4 font-bold leading-tight tracking-tight text-gray-900 md:text-2xl dark:text-white">
                        Login
                    </h1>
                    <p class="text-sm font-light text-center text-gray-500 dark:text-gray-400">
                        Don't have an account? 
                        <a href="/register" class="font-medium text-green-600 underline dark:text-green-500">
                            Sign Up
                        </a>
                    </p>
                    <form class="space-y-4" action="/login" method="POST">
                        ...
                        <button type="submit"
                            class="w-full text-white bg-green-600 hover:bg-green-700 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-sm text-sm px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Sign In
                        </button>
                        {{-- or --}}
                        <div class="inline-flex items-center justify-center w-full">
                            <hr class="w-64 h-px my-2 bg-gray-200 border-0 dark:bg-gray-700">
                            <span class="absolute text-gray-500 px-3 font-medium text-gray-900 -translate-x-1/2 bg-white left-1/2 dark:text-white dark:bg-gray-900">or</span>
                        </div>
                        {{-- socialite button --}}

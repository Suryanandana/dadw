        ...
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
            <div
                ...
                <div class="p-6 sm:p-8">
                    <h1
                        class="text-xl mb-4 text-center font-bold text-gray-900 md:text-4xl dark:text-white">
                            Register
                    </h1>
                    @if ($errors->any())
                    ...
                    <form class="space-y-4" action="/register" method="POST">
                        ...
                        <button type="submit"
                            class="w-full text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-sm text-sm px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
                            Register Now
                        </button>

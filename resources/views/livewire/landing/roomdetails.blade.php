...
<head>
    ...
    <title>{{$data->room_name}} Details</title>
...
<body x-details="{fmodal: false, fdesc: '', ftitle: ''}">
    ...
    <header class="2xl:h-auto 2xl:aspect-video shadow-[inset_0px_-150px_150px_-50px] shadow-stone-950 relative z-10 max-w-screen-2xl w-full top-0 2xl:left-1/2 2xl:translate-x-[-50%]">
        ...
        <img src="{{asset('img/landing/'.$data->imgdir)}}" class="2xl:h-auto 2xl:aspect-video shadow-[inset_0px_-150px_150px_-50px] shadow-stone-950 relative z-10 max-w-screen-2xl w-full top-0 2xl:left-1/2 2xl:translate-x-[-50%]" alt="">
        <!-- </div> -->
    </header>
    ...
    {{-- deskripsi --}}        
            <h2 class="text-xs text-center text-gray-400 tracking-widest">ROOM DETAILS</h2>
            <h3 class="text-4xl text-center text-gray-800 tracking-wide font-serif">{{$data->room_name}}</h3>
            
            <p class="text-center leading-loose tracking-widest">{{$data->description}}
            </p>
        ...
        {{-- service gallery --}}
        <h2 class="my-10 text-4xl text-center font-serif">{{$data->room_name}} Gallery</h2>
    ...
    <section class="py-14 mt-10">
        <h2 class="mb-5 text-4xl text-center font-serif">{{$data->room_name}} Testimonials</h2>

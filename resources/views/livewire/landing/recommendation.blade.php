...
<section>
    <h2 class="font-serif text-4xl text-center mt-14">Our Recommended Packages</h2>
    ...
    <div class="flex flex-col items-center gap-3 px-5 md:gap-12 md:flex-row">
        <div class="basis-1/2 lg:basis-2/5">
            <img class="w-full object-cover aspect-[4/3] rounded-sm" alt="{{ $item->package_name }}" src="{{ asset('storage/img/service/'.$item->imgdir) }}">
        </div>
        <div class="text-left basis-1/2 lg:basis-3/5">
            ...
            <div class="mt-5">
                <a href="{{ route('package.details', ['id' => $item->id]) }}" class="inline-flex px-8 py-3 text-xs tracking-widest text-white bg-green-700 border-0 rounded-sm focus:outline-none hover:bg-green-800">
                    MORE DETAILS
                </a>
            </div>
        </div>

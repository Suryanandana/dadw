...
@endsection
<main class="grid grid-cols-1 gap-3 p-5 bg-gray-100 rounded xl:col-span-2">
    @include('customer.navbar')
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-x-2">
                ...
                <div class="relative p-2 bg-gray-200 rounded-full cursor-pointer" x-data="{check: false}"
                    ...
                    <svg x-bind:class="check ? 'opacity-0 rotate-[360deg] duration-500' : 'duration-1000'"
                        class="absolute w-6 h-6 text-gray-800 transition-all dark:text-white"
                        aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                        fill="none" viewBox="0 0 24 24">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                            stroke-width="2" d="M5 12h14m-7 7V5" />
                    </svg>
                    <svg x-cloak x-bind:class="check ? 'z-10 duration-1000' : 'opacity-0 rotate-[360deg] duration-500'"
                        class="absolute w-6 h-6 text-green-800 transition-all"
                        aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                        fill="none" viewBox="0 0 24 24">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="p-2 bg-gray-200 rounded-full cursor-pointer" x-on:click="open = !open">
                    <svg class="w-6 h-6 text-gray-800 transition-transform dark:text-white"
                        x-bind:class="open ? 'rotate-180' : ''" aria-hidden="true"
                        xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                        viewBox="0 0 24 24">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
    ...
    @endforeach
    <a href="/livewire2" wire:navigate>pindah</a>
</main>

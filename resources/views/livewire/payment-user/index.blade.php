    ...
    <ol
        ...
        <li x-bind:class="(currentStep === 3) ? 'text-green-600 dark:text-green-500' : 'text-gray-600 dark:text-gray-500'"
            ...
            <span
                ...
                <span x-show="!(currentStep === 3)" class="me-2">3</span>
        ...
        <li
            ...
            <span
                class="flex items-center after:content-['/'] sm:after:hidden after:mx-2 after:text-gray-200 dark:after:text-gray-500">
                <span class="me-2">4</span>Verified
                <span class="hidden sm:inline-flex sm:ms-2">Email</span>
            </span>
        </li>
        <li x-bind:class="(currentStep === 4) ? 'text-green-600 dark:text-green-500' : 'text-gray-600 dark:text-gray-500'"
            class="flex md:w-full items-center sm:after:content-[''] after:w-full after:h-1 after:border-b after:border-gray-200 after:border-1 after:hidden sm:after:inline-block after:mx-6 xl:after:mx-10 dark:after:border-gray-700">
            <span
                class="flex items-center after:content-['/'] sm:after:hidden after:mx-2 after:text-gray-200 dark:after:text-gray-500">
                <svg x-show="(currentStep === 4)" class="w-3.5 h-3.5 sm:w-4 sm:h-4 me-2.5" aria-hidden="true"
                    xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                    <path
                        d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5Zm3.707 8.207-4 4a1 1 0 0 1-1.414 0l-2-2a1 1 0 0 1 1.414-1.414L9 10.586l3.293-3.293a1 1 0 0 1 1.414 1.414Z" />
                </svg>
                <span x-show="!(currentStep === 4)" class="me-2">5</span>
                <span class="hidden lg:inline-flex lg:ms-2 lg:mr-1">Payment</span>
            </span>
        </li>
    </ol>
    {{-- stepper mobile --}}
